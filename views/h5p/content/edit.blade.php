            ...
            <div class="col-md-12">
                            ...
                            <small class="h5p-disable-file-check helper-block">
                                <label class="">
                                    <input type="checkbox" name="h5p_disable_file_check"
                                           id="h5p-disable-file-check"/> {{ trans('laravel-h5p.content.upload_disable_extension_check') }}
                                </label>
                            </small>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <button class="btn btn-danger h5p-delete" data-delete="{{ route('h5p.destroy', $id) }}"
                                type="button">
                            {{ __('strings.delete') }}
                        </button>

                        <div>
                            <a href="{{ route('h5p.index') }}" class="btn btn-default"><i
                                        class="fa fa-reply"></i> {{ trans('laravel-h5p.content.cancel') }}</a>
