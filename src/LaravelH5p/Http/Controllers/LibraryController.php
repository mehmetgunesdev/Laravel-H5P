...
class LibraryController extends Controller
{
    ...
    public function restrict(Request $request): \Illuminate\Http\JsonResponse
    {
    ...
    private function assets($scripts = [], $styles = []): array
    {
     ...
     *
     */
    private function get_library(int $id = null)
    {
...
//    }
     ...
     * @since 1.1.0
     */
    private function get_not_cached_settings($num): array
    {
        return [
            'num' => $num,
...
//
//    public function get_not_cached_settings(mixed $num): mixed
//    {
//        return array(
//            'num' => $num,
